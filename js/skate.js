...
export class Skater {
  ...
  stepRide(dt, inp, ev, manual) {
    ...
    // stairs and skate ramps climb faster than the default stepUp allows per substep
    const onStairs = this.groundKind === 'stairs' || this.groundKind === 'ramp' || this.groundKind === 'quarter';
